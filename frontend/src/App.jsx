...
function App() {
  ...
  const [retrievalMode, setRetrievalMode] = useState('vector'); // 'vector' | 'bm25' | 'hybrid'
          ...
          <div className="page-header-row">
            <div className="page-header-info">
              {view === 'ingest' ? (
                ...
                <>
                  <h1 className="page-title">RAG Trace Logs Explorer</h1>
                  <p className="page-subtitle">Inspect historical operations, model execution timings, and semantic vector match scores.</p>
                </>
              )}
            </div>
